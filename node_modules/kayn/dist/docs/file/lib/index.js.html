...
<head>
  ...
  <title data-ice="title">lib/index.js | kayn</title>
...
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">module.exports = require(&apos;Kayn&apos;);
</code></pre>
