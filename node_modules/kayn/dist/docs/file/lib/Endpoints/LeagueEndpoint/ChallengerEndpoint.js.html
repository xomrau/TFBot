...
<head>
  ...
  <title data-ice="title">lib/Endpoints/LeagueEndpoint/ChallengerEndpoint.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Endpoints/LeagueEndpoint/ChallengerEndpoint.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">import LeagueSuperclass from &apos;./LeagueSuperclass&apos;;
...
class ChallengerEndpoint extends LeagueSuperclass {
   ...
   * 
   * Implements /lol/league/v3/challengerleagues/by-queue/{queue}.
   *  
