...
<head>
  ...
  <title data-ice="title">lib/Endpoints/SpectatorEndpoint/CurrentGameEndpoint.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Endpoints/SpectatorEndpoint/CurrentGameEndpoint.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">import SpectatorSuperclass from &apos;./SpectatorSuperclass&apos;;
...
class CurrentGameEndpoint extends SpectatorSuperclass {
   ...
   * 
   * Implements /lol/spectator/v3/active-games/by-summoner/{summonerId}.
   *  
