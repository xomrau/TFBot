...
<head>
  ...
  <title data-ice="title">lib/Utils/ParameterHelper.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Utils/ParameterHelper.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">const isKeyValid = key =&gt; key &amp;&amp; typeof key === &apos;string&apos;;
