...
const createRequestURL = (platformID, serviceName, endpoint) => `https://${platformID}.${API_HOST}/lol/${serviceName}/${API_VERSION}/${endpoint}`;
...
const getURLWithQuery = (region, serviceName, endpoint, queryArray) => createRequestURL(region, serviceName, endpoint) + getQueryParamString(queryArray);
