...
class LeaguePositionsEndpoint extends _LeagueSuperclass2.default {
    ...
    */
    summonerID(summonerID) {
        return new _Request2.default(this.config, this.serviceName, `positions/by-summoner/${summonerID}`, _methodNames2.default.LEAGUE.GET_ALL_LEAGUE_POSITIONS_FOR_SUMMONER, 'GET', this.limiter);
    }
}

exports.default = LeaguePositionsEndpoint;