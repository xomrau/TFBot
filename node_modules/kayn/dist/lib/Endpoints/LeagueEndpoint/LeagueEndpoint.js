...
class LeagueEndpoint extends _LeagueSuperclass2.default {
    ...
    */
    uuid(leagueUUID) {
        return new _Request2.default(this.config, this.serviceName, `leagues/${leagueUUID}`, _methodNames2.default.LEAGUE.GET_LEAGUE_BY_ID, 'GET', this.limiter);
    }
}

exports.default = LeagueEndpoint;