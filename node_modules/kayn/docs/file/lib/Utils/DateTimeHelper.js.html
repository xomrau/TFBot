...
<head>
  ...
  <title data-ice="title">lib/Utils/DateTimeHelper.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Utils/DateTimeHelper.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">const checkIfDateParam = tag =&gt; tag === &apos;beginTime&apos; || tag === &apos;endTime&apos;;
