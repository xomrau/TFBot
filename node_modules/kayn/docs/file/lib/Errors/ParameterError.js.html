...
<head>
  ...
  <title data-ice="title">lib/Errors/ParameterError.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Errors/ParameterError.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">class ParameterError extends Error {
    constructor(message) {
        super(message);
    }
}
