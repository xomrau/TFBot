...
<head>
  ...
  <title data-ice="title">lib/Endpoints/ThirdPartyCodeEndpoint.js | kayn</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/Endpoints/ThirdPartyCodeEndpoint.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">import PlatformSuperclass from &apos;./PlatformSuperclass&apos;;
...
class ThirdPartyCodeEndpoint extends PlatformSuperclass {
   ...
   * 
   * Implements /lol/platform/v3/third-party-code/by-summoner/{summonerId}.
   *  
